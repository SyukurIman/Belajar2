...
class GetCurrentWeatherJobService : JobService() {
    ...
    companion object {
        ...
        internal const val APP_ID = "fe58c4fa8c45b305a28318dd830d28c6"
    }
        ...
        client.get(url, object : AsyncHttpResponseHandler() {
            override fun onSuccess(statusCode: Int, headers: Array<Header>, responseBody: ByteArray) {
                ...
                try {
                    ...
                    val currentWeather = responsObject.getJSONArray("weather").getJSONObject(0).getString("main")
                    val description = responsObject.getJSONArray("weather").getJSONObject(0).getString("description")
                    val tempInKelvin = responsObject.getJSONObject("main").getDouble("temp")
